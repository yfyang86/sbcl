;;;; the WebAssembly VM definition of character operations
...
(define-vop (move-from-character)
  ...
  (:generator 1
    (store-reg y
      ...
      (inst i32.const n-widetag-bits)
      (inst i32.shl)
      (inst i32.const character-widetag)
      (inst i32.or))))
...
;;; Use standard MOVE-ARG + coercion to move an untagged character to a
