...
$RUN src/runtime/sbcl.wasm --core "$CORE" --noinform --no-sysinit --no-userinit --disable-debugger \
...
$RUN src/runtime/sbcl.wasm --core "$CORE" --noinform --no-sysinit --no-userinit --disable-debugger --noprint \
