...
case "$WASM_HOST_SYSTEM-$WASM_HOST_ARCH" in
    ...
    *)
        ...
        WASMTIME_BIN_PATH=${WASMTIME_BIN_PATH:-$HOME/.wasmtime/bin}
        WASMTOOLS_BIN_PATH=${WASMTOOLS_BIN_PATH:-$HOME/.cargo/bin}
        WASISDK_ASSET=""; WASMTIME_ASSET=""; WASMTOOLS_ASSET=""; SBCL_HOST_ASSET=""
        ;;
esac
...
PATH="$WASMTIME_BIN_PATH:$WASMTOOLS_BIN_PATH:$PATH"
export WASISDK_PATH WASMTIME_BIN_PATH WASMTOOLS_BIN_PATH WASI_SDK PATH
export WASM_HOST_SYSTEM WASM_HOST_ARCH
export WASISDK_VERSION WASMTIME_VERSION WASMTOOLS_VERSION SBCL_HOST_VERSION
export WASISDK_ASSET WASMTIME_ASSET WASMTOOLS_ASSET SBCL_HOST_ASSET
export WASISDK_URL WASMTIME_URL WASMTOOLS_URL SBCL_HOST_URL
